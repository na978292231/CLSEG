...
class NFLAT(nn.Module):
    def __init__(self, tag_vocab, char_embed, word_embed, num_layers, hidden_size, n_head, feedforward_dim, dropout,
                 max_seq_len, max_lex_num,after_norm=True, attn_type='adatrans',  bi_embed=None, softmax_axis=-2,
        ...
        self.informer = InterFormerEncoder(tag_vocab,num_layers, hidden_size, n_head, max_seq_len, max_lex_num,feedforward_dim, softmax_axis=softmax_axis,
